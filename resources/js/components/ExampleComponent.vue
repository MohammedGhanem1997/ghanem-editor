...
const editorDefaultOptions = {
    ...
    default: true,
    loadImage: {
      path: 'https://media.istockphoto.com/photos/white-texture-background-picture-id926993450?b=1&k=20&m=926993450&s=170667a&w=0&h=vxWViBkXgTQnSO4UTtU26hLlscn9FTKYS1Jx6f-_slI=',
      name: 'sampleImage2',
    },
    uiSize: {
      width: '100%',
